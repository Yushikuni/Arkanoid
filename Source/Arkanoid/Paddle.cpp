...
APaddle::APaddle()
{
	...
	SM_Padle->SetEnableGravity(false); //pokud nechci aby paddle spadl
	SM_Padle->SetConstraintMode(EDOFMode::XZPlane); //hrac nepude nahoru a dolu, takze pohyb je jen vlevo a vpravo
